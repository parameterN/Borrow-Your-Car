    ...
    return (
        <div className='container'>
            ...
            <div className='main'>
                ...
                <div>花费{}浙大币，赢取更多浙大币！每个人可以参与多次，参与越多，得奖概率越高！</div>
                <div>
                </div>
                <div>
                    奖池有金额 {} 个ZJUToken
                ...
                <div className='operation'>
                    ...
                    <div className='buttons'>
                        <Button style={{width: '200px'}}>投注产生希望</Button>
                        <Button style={{width: '200px'}}>开奖（仅限管理员使用）</Button>
                        <Button style={{width: '200px'}}>退款（仅限管理员使用</Button>
                    </div>
                </div>
            </div>
        </div>
